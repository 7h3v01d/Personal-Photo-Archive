...
class TagHomeDialog(QDialog):
    ...
    def __init__(self, conn, home: TagHomeView, parent=None, *, cache_dir: Path | None = None) -> None:
        ...
        self._thumb_worker=ThumbnailWorker(self._cache_dir,size=210,conn=self._conn); self._thumb_worker.ready.connect(self._thumbnail_ready,Qt.ConnectionType.QueuedConnection); self._registry.start_persistent(self._thumb_worker); self._render_page()
